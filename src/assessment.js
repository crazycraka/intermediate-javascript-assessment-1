...
function async(){     return setTimeout(function(){}, .2000) }
...
function context1(myFn, context, param1, param2) {     return myFn.call(context, param1, param2); }
...
function context2(myFn, context, params) {     return myFn.apply(context, params) }
...
function context3(myFn, context) {     return myFn.bind(context); }
...
function Taco(shell, meat, veggies){     this.shell = shell;     this.meat = meat;     this.veggies = veggies; }
...
function Burrito(){     this.percentLeft = 100;     this.eat = function() {         return this.percentLeft = this.percentLeft - 25;     }; }


// #8  ###################
// # Prototype 1
// Add prototype function to the array type that doubles the value of every item in the array
Array.prototype.doubler = function(){    return this.map(function(value, index){        return value * 2;    }); }
...
function Chimichanga() {     this.percentLeft = 100;     this.eat = function(){         return this.percentLeft = this.percentLeft - 20;     }; }
...
function sentenceMachine(partOne) {     return function sentenceSmasher(partTwo) {         return partOne + partTwo;     } }
...
function subway(personName){     return function addIngredient(ingredient) {         return {orderPerson: personName,             ingredients: [ingredient]         }     } }
...
function compareValues(param1, param2){     console.log("--" + typeof param1 + " ---" + typeof param2)     if(typeof param1 === typeof param2 && param1 === param2){          return "Exact match";      }     else if (typeof param1 != typeof param2 && Number(param1) === Number(param2)){         return "Different types";     }     else{         return "Different values"     } }
